...
var p10fa = {
  projNum: "p10fa",
  imgSrc: "<%= asset_path("projects/10fa.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/10fa_1.jpg") %>", exDescr:"Linear Organization"}, {imgSrc:"<%= asset_path("exhibits/10fa_2.jpg") %>", exDescr:"Mirror, Scale, Rotate & Linear Alignment"}, {imgSrc:"<%= asset_path("exhibits/10fa_3.jpg") %>", exDescr:"Circulation"}, {imgSrc:"<%= asset_path("exhibits/10fa_4.jpg") %>", exDescr:"Plan"}, {imgSrc:"<%= asset_path("exhibits/10fa_5.jpg") %>", exDescr:"Longitudinal Elevation and Section"}, {imgSrc:"<%= asset_path("exhibits/10fa_6.jpg") %>", exDescr:"Transverse Sections"}, {imgSrc:"<%= asset_path("exhibits/10fa_7.jpg") %>", exDescr:"Massing Axon"}]
};
var p11fa = {
  projNum: "p11fa",
  imgSrc: "<%= asset_path("projects/11fa.jpg") %>",
  tagDescr: "Slanguage",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/11fa_1.jpg") %>", exDescr:"Slanguage Art Facility"}, {imgSrc:"<%= asset_path("exhibits/11fa_2.jpg") %>", exDescr:"Branching System"}, {imgSrc:"<%= asset_path("exhibits/11fa_3.jpg") %>", exDescr:"Occupation"}, {imgSrc:"<%= asset_path("exhibits/11fa_4.jpg") %>", exDescr:"Ground Relationship"}, {imgSrc:"<%= asset_path("exhibits/11fa_5.jpg") %>", exDescr:"Site Plan"}, {imgSrc:"<%= asset_path("exhibits/11fa_6.jpg") %>", exDescr:"Roof Plan"}, {imgSrc:"<%= asset_path("exhibits/11fa_7.jpg") %>", exDescr:"Plan Cut"}, {imgSrc:"<%= asset_path("exhibits/11fa_8.jpg") %>", exDescr:"Section A"}, {imgSrc:"<%= asset_path("exhibits/11fa_9.jpg") %>", exDescr:"Section B"}, {imgSrc:"<%= asset_path("exhibits/11fa_10.jpg") %>", exDescr:"Model \[1\/16\" : 1\'\-0\"\]"}]
};
var p12sp = {
  projNum: "p12sp",
  imgSrc: "<%= asset_path("projects/12sp.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/12sp_1.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/12sp_2.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/12sp_3.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/12sp_4.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/12sp_5.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/12sp_6.jpg") %>", exDescr:""}]
};
var p12spCube = {
  projNum: "p12spCube",
  imgSrc: "<%= asset_path("projects/12spCube.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/12spCube_1.jpg") %>", exDescr:"Paper"}, {imgSrc:"<%= asset_path("exhibits/12spCube_2.jpg") %>", exDescr:"Wood"}, {imgSrc:"<%= asset_path("exhibits/12spCube_3.jpg") %>", exDescr:"Concrete"}]
};
var p12spSketch = {
  projNum: "p12spSketch",
  imgSrc: "<%= asset_path("projects/12spSketch.jpg") %>",
  tagDescr: "Sketchbook",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/12spSketch_1.jpg") %>", exDescr:"Chinese Garden, The Huntington Library, Art Collections, and Botanical Gardens"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_2.jpg") %>", exDescr:"Mudd Hall of Philosophy, USC No.1"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_3.jpg") %>", exDescr:"Mudd Hall of Philosophy, USC No.2"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_4.jpg") %>", exDescr:"Mudd Hall of Philosophy, USC No.3"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_5.jpg") %>", exDescr:"Widney Alumni House, USC"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_6.jpg") %>", exDescr:"Harris Hall Courtyard, USC"}, {imgSrc:"<%= asset_path("exhibits/12spSketch_7.jpg") %>", exDescr:"Registration Building, USC"}]
};
var p13sp = {
  projNum: "p13sp",
  imgSrc: "<%= asset_path("projects/13sp.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/13sp_1.jpg") %>", exDescr:"Model \[1\/16\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_2.jpg") %>", exDescr:"Concept Diagrams"}, {imgSrc:"<%= asset_path("exhibits/13sp_3.jpg") %>", exDescr:"Organization"}, {imgSrc:"<%= asset_path("exhibits/13sp_4.jpg") %>", exDescr:"Plans \[Ground \& Second Level\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_5.jpg") %>", exDescr:"Plans \[Third \& Fourth Level\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_6.jpg") %>", exDescr:"Longitudinal Section"}, {imgSrc:"<%= asset_path("exhibits/13sp_7.jpg") %>", exDescr:"Transverse Section"}, {imgSrc:"<%= asset_path("exhibits/13sp_8.jpg") %>", exDescr:"Courtyard View"}, {imgSrc:"<%= asset_path("exhibits/13sp_9.jpg") %>", exDescr:"Exploded Detail"}, {imgSrc:"<%= asset_path("exhibits/13sp_10.jpg") %>", exDescr:"Detail Model \[3\/4\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_11.jpg") %>", exDescr:"Sectional Model \[1\/4\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_12.jpg") %>", exDescr:"Sectional Model \[1\/4\" : 1\'\-0\"\]"}]
};
var p13faTo = {
  projNum: "p13faTo",
  imgSrc: "<%= asset_path("projects/13faTo.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/13faTo_1.jpg") %>", exDescr:"Massing"}, {imgSrc:"<%= asset_path("exhibits/13faTo_2.jpg") %>", exDescr:"Tectonics"}, {imgSrc:"<%= asset_path("exhibits/13faTo_3.jpg") %>", exDescr:"Program & Circulation"}, {imgSrc:"<%= asset_path("exhibits/13faTo_4.jpg") %>", exDescr:"Master Plan"}, {imgSrc:"<%= asset_path("exhibits/13faTo_5.jpg") %>", exDescr:"Site Section \[1 of 2\]"}, {imgSrc:"<%= asset_path("exhibits/13faTo_6.jpg") %>", exDescr:"Site Section \[2 of 2\]"}, {imgSrc:"<%= asset_path("exhibits/13faTo_7.jpg") %>", exDescr:"Waterfront Market Plan"}]
};
var p13faSh = {
  projNum: "p13faSh",
  imgSrc: "<%= asset_path("projects/13faSh.jpg") %>",
  tagDescr: "Permeate",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/13faSh_1.jpg") %>", exDescr:"Public Space Site Analysis"}, {imgSrc:"<%= asset_path("exhibits/13faSh_2.jpg") %>", exDescr:"Street-scape Objects"}, {imgSrc:"<%= asset_path("exhibits/13faSh_3.jpg") %>", exDescr:"Live-Work"}, {imgSrc:"<%= asset_path("exhibits/13faSh_4.jpg") %>", exDescr:"Low-Rise Residential"}, {imgSrc:"<%= asset_path("exhibits/13faSh_5.jpg") %>", exDescr:"Riverfront-Residential"}, {imgSrc:"<%= asset_path("exhibits/13faSh_6.jpg") %>", exDescr:"Organization"}, {imgSrc:"<%= asset_path("exhibits/13faSh_7.jpg") %>", exDescr:"Public Garden Space"}, {imgSrc:"<%= asset_path("exhibits/13faSh_8.jpg") %>", exDescr:"1 Community Garden \| 2 Gallery \| 3 Library \| 4 Administration \| 5 Lobby \| 6 Cafe \| 7 Park Space \| 8 Support \| 9 Commercial"}, {imgSrc:"<%= asset_path("exhibits/13faSh_9.jpg") %>", exDescr:"Lower Level"}, {imgSrc:"<%= asset_path("exhibits/13faSh_10.jpg") %>", exDescr:"Ground Level"}, {imgSrc:"<%= asset_path("exhibits/13faSh_11.jpg") %>", exDescr:"Second Level"}, {imgSrc:"<%= asset_path("exhibits/13faSh_12.jpg") %>", exDescr:"Third Level"}, {imgSrc:"<%= asset_path("exhibits/13faSh_13.jpg") %>", exDescr:"Section A"}, {imgSrc:"<%= asset_path("exhibits/13faSh_14.jpg") %>", exDescr:"Section B"}, {imgSrc:"<%= asset_path("exhibits/13faSh_15.jpg") %>", exDescr:"Section C"}, {imgSrc:"<%= asset_path("exhibits/13faSh_16.jpg") %>", exDescr:"Section D"}, {imgSrc:"<%= asset_path("exhibits/13faSh_17.jpg") %>", exDescr:"Model \[1:200\]"}]
};
var p14sp = {
  projNum: "p14sp",
  imgSrc: "<%= asset_path("projects/14sp.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14sp_1.jpg") %>", exDescr:"Variety Spectrum"}, {imgSrc:"<%= asset_path("exhibits/14sp_2.jpg") %>", exDescr:"Micro Social Interactions"}, {imgSrc:"<%= asset_path("exhibits/14sp_3.jpg") %>", exDescr:"Group Aggregation"}, {imgSrc:"<%= asset_path("exhibits/14sp_4.jpg") %>", exDescr:"Hybridize Public and Private Space"}, {imgSrc:"<%= asset_path("exhibits/14sp_5.jpg") %>", exDescr:"Maximize Billboard Facades"}, {imgSrc:"<%= asset_path("exhibits/14sp_6.jpg") %>", exDescr:"110 S View"}, {imgSrc:"<%= asset_path("exhibits/14sp_7.jpg") %>", exDescr:"Macro Social Ecology"}, {imgSrc:"<%= asset_path("exhibits/14sp_8.jpg") %>", exDescr:"Community Clusters"}, {imgSrc:"<%= asset_path("exhibits/14sp_9.jpg") %>", exDescr:"Flexible Shared Spaces"}, {imgSrc:"<%= asset_path("exhibits/14sp_10.jpg") %>", exDescr:"Massing Model \[1\/32\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/14sp_11.jpg") %>", exDescr:"Site Plan"}, {imgSrc:"<%= asset_path("exhibits/14sp_12.jpg") %>", exDescr:"Typical Levels 5\-7 & Levels 2\-4 Plan"}, {imgSrc:"<%= asset_path("exhibits/14sp_13.jpg") %>", exDescr:"Courtyard Section"}, {imgSrc:"<%= asset_path("exhibits/14sp_14.jpg") %>", exDescr:"Community Center Entrance"}, {imgSrc:"<%= asset_path("exhibits/14sp_15.jpg") %>", exDescr:"Community Center Section"}]
};
var p14spSoA = {
  projNum: "p14spSoA",
  imgSrc: "<%= asset_path("projects/14spSoA.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14spSoA_1.jpg") %>", exDescr:"100 Years of Architecture & Next 100 Years"}, {imgSrc:"<%= asset_path("exhibits/14spSoA_2.jpg") %>", exDescr:"Lecture Poster"}, {imgSrc:"<%= asset_path("exhibits/14spSoA_3.jpg") %>", exDescr:"Blue Tape"}, {imgSrc:"<%= asset_path("exhibits/14spSoA_4.jpg") %>", exDescr:"Student Exhibition"}, {imgSrc:"<%= asset_path("exhibits/14spSoA_5.jpg") %>", exDescr:"Asian Architecture & Urbanism Study Abroad Exhibition"}]
};
var p14su = {
  projNum: "p14su",
  imgSrc: "<%= asset_path("projects/14su.jpg") %>",
  tagDescr: "Hub x Hub",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14su_1.jpg") %>", exDescr:"Program Concept"}, {imgSrc:"<%= asset_path("exhibits/14su_2.jpg") %>", exDescr:"Active Gound Floor and Office Massing Scheme \(Provided by Forest City\)"}, {imgSrc:"<%= asset_path("exhibits/14su_3.jpg") %>", exDescr:"Edge Condition"}, {imgSrc:"<%= asset_path("exhibits/14su_4.jpg") %>", exDescr:"Vertical Public Circulation"}, {imgSrc:"<%= asset_path("exhibits/14su_5.jpg") %>", exDescr:"Extension of Designed Public Space"}, {imgSrc:"<%= asset_path("exhibits/14su_6.jpg") %>", exDescr:"Sectional Relationsihp of Ramps"}, {imgSrc:"<%= asset_path("exhibits/14su_7.jpg") %>", exDescr:"Ground Level Plan"}, {imgSrc:"<%= asset_path("exhibits/14su_8.jpg") %>", exDescr:"Park View"}, {imgSrc:"<%= asset_path("exhibits/14su_9.jpg") %>", exDescr:"Second Level Plan"}, {imgSrc:"<%= asset_path("exhibits/14su_10.jpg") %>", exDescr:"Hub \"Hub\" Lobby Atrium"}, {imgSrc:"<%= asset_path("exhibits/14su_11.jpg") %>", exDescr:"Third Level Plan"}, {imgSrc:"<%= asset_path("exhibits/14su_12.jpg") %>", exDescr:"Fourth Level Plan"}, {imgSrc:"<%= asset_path("exhibits/14su_13.jpg") %>", exDescr:"Study Model \[1:500\]"}]
};
var p14fa = {
  projNum: "p14fa",
  imgSrc: "<%= asset_path("projects/14fa.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14fa_1.jpg") %>", exDescr:"Downtown San Pedro"}, {imgSrc:"<%= asset_path("exhibits/14fa_2.jpg") %>", exDescr:"Site Map"}, {imgSrc:"<%= asset_path("exhibits/14fa_3.jpg") %>", exDescr:"Street Context"}, {imgSrc:"<%= asset_path("exhibits/14fa_4.jpg") %>", exDescr:"Framing Nature"}, {imgSrc:"<%= asset_path("exhibits/14fa_5.jpg") %>", exDescr:"Framing Structure"}, {imgSrc:"<%= asset_path("exhibits/14fa_6.jpg") %>", exDescr:"Human\-Plant Relationship and Sustainable Strategy"}, {imgSrc:"<%= asset_path("exhibits/14fa_7.jpg") %>", exDescr:"Unit Detail"}, {imgSrc:"<%= asset_path("exhibits/14fa_8.jpg") %>", exDescr:"Ground Level"}, {imgSrc:"<%= asset_path("exhibits/14fa_9.jpg") %>", exDescr:"Second Level"}, {imgSrc:"<%= asset_path("exhibits/14fa_10.jpg") %>", exDescr:"Third Level \[Typical Plan\]"}, {imgSrc:"<%= asset_path("exhibits/14fa_11.jpg") %>", exDescr:"Tenth Level"}, {imgSrc:"<%= asset_path("exhibits/14fa_12.jpg") %>", exDescr:"Longitudinal Section"}, {imgSrc:"<%= asset_path("exhibits/14fa_13.jpg") %>", exDescr:"Transverse Section"}, {imgSrc:"<%= asset_path("exhibits/14fa_14.jpg") %>", exDescr:"Detail Section"}, {imgSrc:"<%= asset_path("exhibits/14fa_15.jpg") %>", exDescr:"Street View"}, {imgSrc:"<%= asset_path("exhibits/14fa_16.jpg") %>", exDescr:"Public Park"}, {imgSrc:"<%= asset_path("exhibits/14fa_17.jpg") %>", exDescr:"Massing Model \[1\/16\" : 1\'\-0\"\]"}]
};
var p14faStl = {
  projNum: "p14faStl",
  imgSrc: "<%= asset_path("projects/14faStl.jpg") %>",
  tagDescr: "Form No. 1",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14faStl_1.jpg") %>", exDescr:"Form No. 1"}, {imgSrc:"<%= asset_path("exhibits/14faStl_2.jpg") %>", exDescr:"Form No. 1"}, {imgSrc:"<%= asset_path("exhibits/14faStl_3.jpg") %>", exDescr:"Process: Grinding & Welding"}]
};
var p14faTbl = {
  projNum: "p14faTbl",
  imgSrc: "<%= asset_path("projects/14faTbl.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/14faTbl_1.jpg") %>", exDescr:"SN 9"}, {imgSrc:"<%= asset_path("exhibits/14faTbl_2.jpg") %>", exDescr:"SN 9"}, {imgSrc:"<%= asset_path("exhibits/14faTbl_3.jpg") %>", exDescr:"Top Detail"}, {imgSrc:"<%= asset_path("exhibits/14faTbl_4.jpg") %>", exDescr:"Assembly"}, {imgSrc:"<%= asset_path("exhibits/14faTbl_5.jpg") %>", exDescr:"Rotation"}]
};
var p15sp = {
  projNum: "p15sp",
  imgSrc: "<%= asset_path("projects/15sp.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/15sp_1.jpg") %>", exDescr:"24 Hours on Broadway Street"}, {imgSrc:"<%= asset_path("exhibits/15sp_2.jpg") %>", exDescr:"Weekly Social Activity"}, {imgSrc:"<%= asset_path("exhibits/15sp_3.jpg") %>", exDescr:"Downtown Los Angeles Demographics"}, {imgSrc:"<%= asset_path("exhibits/15sp_4.jpg") %>", exDescr:"Existing Street Scape"}, {imgSrc:"<%= asset_path("exhibits/15sp_5.jpg") %>", exDescr:"Intervention A"}, {imgSrc:"<%= asset_path("exhibits/15sp_6.jpg") %>", exDescr:"Intervention B"}, {imgSrc:"<%= asset_path("exhibits/15sp_7.jpg") %>", exDescr:"Intervention C"}, {imgSrc:"<%= asset_path("exhibits/15sp_8.jpg") %>", exDescr:"Section A"}, {imgSrc:"<%= asset_path("exhibits/15sp_9.jpg") %>", exDescr:"Section B"}, {imgSrc:"<%= asset_path("exhibits/15sp_10.jpg") %>", exDescr:"Section C"}, {imgSrc:"<%= asset_path("exhibits/15sp_11.jpg") %>", exDescr:"Southeast Elevation"}, {imgSrc:"<%= asset_path("exhibits/15sp_12.jpg") %>", exDescr:"Northwest Elevation"}, {imgSrc:"<%= asset_path("exhibits/15sp_13.jpg") %>", exDescr:"Formal \"Paint By Numbers\""}, {imgSrc:"<%= asset_path("exhibits/15sp_14.jpg") %>", exDescr:"Broadway Street: Morning"}, {imgSrc:"<%= asset_path("exhibits/15sp_15.jpg") %>", exDescr:"Broadway Street: Morning"}, {imgSrc:"<%= asset_path("exhibits/15sp_16.jpg") %>", exDescr:"Broadway Street: Afternoon"}, {imgSrc:"<%= asset_path("exhibits/15sp_17.jpg") %>", exDescr:"Broadway Street: Afternoon"}, {imgSrc:"<%= asset_path("exhibits/15sp_18.jpg") %>", exDescr:"Broadway Street: Night"}, {imgSrc:"<%= asset_path("exhibits/15sp_19.jpg") %>", exDescr:"Broadway Street: Night"}]
};
var p15spPrint = {
  projNum: "p15spPrint",
  imgSrc: "<%= asset_path("projects/15spPrint.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/15spPrint_1.jpg") %>", exDescr:"12 x 5"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_2.jpg") %>", exDescr:"Family Room"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_3.jpg") %>", exDescr:"Family Room"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_4.jpg") %>", exDescr:"Set-up"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_5.jpg") %>", exDescr:"Preliminary Critique"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_6.jpg") %>", exDescr:"Linocuts"}, {imgSrc:"<%= asset_path("exhibits/15spPrint_7.jpg") %>", exDescr:"Process"}]
};
var p15spCath = {
  projNum: "p15spCath",
  imgSrc: "<%= asset_path("projects/15spCath.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/15spCath_1.jpg") %>", exDescr:"Daybreak"}, {imgSrc:"<%= asset_path("exhibits/15spCath_2.jpg") %>", exDescr:"Dusk"}, {imgSrc:"<%= asset_path("exhibits/15spCath_3.jpg") %>", exDescr:"Corner"}, {imgSrc:"<%= asset_path("exhibits/15spCath_4.jpg") %>", exDescr:"Courtyard"}, {imgSrc:"<%= asset_path("exhibits/15spCath_5.jpg") %>", exDescr:"Angel"}, {imgSrc:"<%= asset_path("exhibits/15spCath_6.jpg") %>", exDescr:"Peaks"}, {imgSrc:"<%= asset_path("exhibits/15spCath_7.jpg") %>", exDescr:"Cross"}, {imgSrc:"<%= asset_path("exhibits/15spCath_8.jpg") %>", exDescr:"Angled"}, {imgSrc:"<%= asset_path("exhibits/15spCath_9.jpg") %>", exDescr:"Beyond"}, {imgSrc:"<%= asset_path("exhibits/15spCath_10.jpg") %>", exDescr:"Angelic"}, {imgSrc:"<%= asset_path("exhibits/15spCath_11.jpg") %>", exDescr:"Fountain"}, {imgSrc:"<%= asset_path("exhibits/15spCath_12.jpg") %>", exDescr:"Canopy"}, {imgSrc:"<%= asset_path("exhibits/15spCath_13.jpg") %>", exDescr:"Anecdote"}, {imgSrc:"<%= asset_path("exhibits/15spCath_14.jpg") %>", exDescr:"Glimpse"}, {imgSrc:"<%= asset_path("exhibits/15spCath_15.jpg") %>", exDescr:"Intrigue"}, {imgSrc:"<%= asset_path("exhibits/15spCath_16.jpg") %>", exDescr:"Distract"}, {imgSrc:"<%= asset_path("exhibits/15spCath_17.jpg") %>", exDescr:"Focus"}, {imgSrc:"<%= asset_path("exhibits/15spCath_18.jpg") %>", exDescr:"Hail"}, {imgSrc:"<%= asset_path("exhibits/15spCath_19.jpg") %>", exDescr:"Retreat"}, {imgSrc:"<%= asset_path("exhibits/15spCath_20.jpg") %>", exDescr:"Shine"}]
};
var m10fa = {
  projNum: "m10fa",
  imgSrc: "<%= asset_path("projects/10fa.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/10fa_1.jpg") %>", exDescr:""}]
};
var m11fa = {
  projNum: "m11fa",
  imgSrc: "<%= asset_path("projects/11fa-m.jpg") %>",
  tagDescr: "Slanguage",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/11fa_10.jpg") %>", exDescr:""}, {imgSrc:"<%= asset_path("exhibits/11fa_1.jpg") %>", exDescr:"Site Context"}]
};
var m13sp = {
  projNum: "m13sp",
  imgSrc: "<%= asset_path("projects/13sp.jpg") %>",
  ...
  exhibit: [{imgSrc:"<%= asset_path("exhibits/13sp_1.jpg") %>", exDescr:"1\/16\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_11.jpg") %>", exDescr:"1\/4\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_12.jpg") %>", exDescr:"1\/4\" : 1\'\-0\"\]"}, {imgSrc:"<%= asset_path("exhibits/13sp_10.jpg") %>", exDescr:"3\/4\" : 1\'\-0\"\]"}]
};
