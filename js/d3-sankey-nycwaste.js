...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["nyc-annual-waste_2017.csv","https://static.observableusercontent.com/files/ec57633c75cc70f4f2d39934e35f82d84684a28a0f083739f6d8df0276751f7fde9769721ca6a936eb38ea4725ec17376b6f891996a29eb0c2400c97fb7cd77c"]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# New York City Waste Flow

Although 75% of New York City's waste stream is composed of recyclable materials, *over 50% of waste is improperly refused* into landfills and incinerators.

Data: [DSNY Average Monthly Tonnage Data, 2017](https://data.cityofnewyork.us/City-Government/DSNY-Monthly-Tonnage-Data/ebb7-mvp5) & [Zero Waste Designing Guidelines](https://www.zerowastedesign.org/)

Forked Chart: [Parallel Sets](https://observablehq.com/@d3/parallel-sets)`
)});
...
d3.scaleOrdinal(["Paper", "Metal, Glass, Plastic", "Textile", "Organic", "Other", "Non-Divertable"], ["#a6cc5b", "#8acad5", "#5d7ecc", "#e5aa25", "#91b7bf", "#bbbbbb"]).unknown("#ccc")
)});
